...
public class PhysicsBodyCategories {
	...
	public static final short MASK_ENEMY_ATTACK = CATEGORY_PLAYER | CATEGORY_PLAYER_ATTACK | CATEGORY_MAP_OBJECT | CATEGORY_OBSTACLE;
	public static final short MASK_ITEM = CATEGORY_PLAYER_SENSOR;
	public static final short MASK_OBSTACLE = CATEGORY_PLAYER | CATEGORY_PLAYER_ATTACK | CATEGORY_ENEMY | CATEGORY_ENEMY_ATTACK | CATEGORY_MAP_OBJECT | CATEGORY_EXPLOSION | CATEGORY_OBSTACLE;

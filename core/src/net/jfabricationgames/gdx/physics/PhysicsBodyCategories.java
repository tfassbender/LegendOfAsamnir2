...
public class PhysicsBodyCategories {
	...
	public static final short MASK_PLAYER_ATTACK = CATEGORY_ENEMY | CATEGORY_ENEMY_ATTACK | CATEGORY_OBSTACLE | CATEGORY_MAP_OBJECT;
	...
	public static final short MASK_ENEMY_ATTACK = CATEGORY_PLAYER | CATEGORY_PLAYER_ATTACK | CATEGORY_MAP_OBJECT;
	public static final short MASK_ITEM = CATEGORY_PLAYER_SENSOR;
	public static final short MASK_OBSTACLE = CATEGORY_PLAYER | CATEGORY_PLAYER_ATTACK | CATEGORY_ENEMY | CATEGORY_MAP_OBJECT | CATEGORY_EXPLOSION | CATEGORY_OBSTACLE;
	public static final short MASK_OBSTACLE_SENSOR = CATEGORY_PLAYER;
	public static final short MASK_MAP_OBJECT = MASK_EVERYTHING;
	public static final short MASK_MAP_UNREACHABLE_AREA = MASK_EVERYTHING;

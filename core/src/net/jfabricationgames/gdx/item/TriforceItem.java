...
public class TriforceItem extends Item {
	...
	public static enum TriforceItemType {
		...
		TRIFORCE_SVARTALFHEIM_MAIN_ISLAND(TriforceItemLocation.SVARTALFHEIM), //
		...
		TRIFORCE_SVARTALFHEIM_CASTLE(TriforceItemLocation.SVARTALFHEIM), //
		TRIFORCE_SVARTALFHEIM_JAIL(TriforceItemLocation.SVARTALFHEIM), //

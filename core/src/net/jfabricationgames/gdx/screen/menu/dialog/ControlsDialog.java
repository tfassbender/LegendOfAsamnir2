...
public class ControlsDialog extends InGameMenuDialog {
	...
	private void drawText() {
		...
		screenTextWriter.drawText("Jump", textColOneX, textRowOneY - 4f * textRowOffset);
		screenTextWriter.drawText("Special", textColOneX, textRowOneY - 5f * textRowOffset);
		screenTextWriter.drawText("Interact", textColOneX, textRowOneY - 6f * textRowOffset);
		screenTextWriter.drawText("Attack", textColOneX, textRowOneY - 7f * textRowOffset);
		screenTextWriter.drawText("Block", textColOneX, textRowOneY - 8f * textRowOffset);
		screenTextWriter.drawText("Change Item", textColOneX, textRowOneY - 9f * textRowOffset);
		screenTextWriter.drawText("Menu", textColOneX, textRowOneY - 10f * textRowOffset);
		...
		screenTextWriter.drawText("F", textColTwoX, textRowOneY - 5f * textRowOffset);
		screenTextWriter.drawText("E", textColTwoX, textRowOneY - 6f * textRowOffset);
		screenTextWriter.drawText("Mouse Left", textColTwoX, textRowOneY - 7f * textRowOffset);
		screenTextWriter.drawText("Mouse Right", textColTwoX, textRowOneY - 8f * textRowOffset);
		screenTextWriter.drawText("R / T", textColTwoX, textRowOneY - 9f * textRowOffset);
		screenTextWriter.drawText("Esc", textColTwoX, textRowOneY - 10f * textRowOffset);
		...
		screenTextWriter.drawText("LB", textColThreeX, textRowOneY - 4f * textRowOffset);
		screenTextWriter.drawText("RB", textColThreeX, textRowOneY - 5f * textRowOffset);
		screenTextWriter.drawText("Y", textColThreeX, textRowOneY - 6f * textRowOffset);
		screenTextWriter.drawText("A / RT", textColThreeX, textRowOneY - 7f * textRowOffset);
		screenTextWriter.drawText("B / LT", textColThreeX, textRowOneY - 8f * textRowOffset);
		screenTextWriter.drawText("X", textColThreeX, textRowOneY - 9f * textRowOffset);
		screenTextWriter.drawText("START", textColThreeX, textRowOneY - 10f * textRowOffset);
	}
}

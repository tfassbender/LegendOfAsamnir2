...
public class StatusBar implements Disposable {
	...
	private final Vector2 healthBarSize = new Vector2(size.x - healthBarUpperRightOffset.x * 2 - iconOffsetX, (size.y - (healthBarUpperRightOffset.y * 4)) * healthBarHeightPercent);
	...
	private final Color[] enduranceBarColorsNormal = new Color[] {//
			new Color(0.9f, 0.9f, 0.1f, 1f), //top-right
			Color.YELLOW, //top-left
	...
	private Color[] enduranceBarColors;
	...
	private void chooseEnduranceBarColors() {
		if (character.isEnduranceLow()) {
			enduranceBarColors = enduranceBarColorsLow;
		}
		else {
			enduranceBarColors = enduranceBarColorsNormal;
		}
	}
	...
	private void drawStatusBar() {
		...
		//bar backgrounds
		shapeRenderer.rect(tileUpperRight.x + healthBarUpperRightOffset.x + iconOffsetX, tileUpperRight.y + healthBarUpperRightOffset.y, healthBarSize.x, healthBarSize.y, barBackgroundColors[0], barBackgroundColors[1], barBackgroundColors[2], barBackgroundColors[3]);
		shapeRenderer.rect(tileUpperRight.x + manaBarUpperRightOffset.x + iconOffsetX, tileUpperRight.y + manaBarUpperRightOffset.y, manaBarSize.x, manaBarSize.y, barBackgroundColors[0], barBackgroundColors[1], barBackgroundColors[2], barBackgroundColors[3]);
		shapeRenderer.rect(tileUpperRight.x + enduranceBarUpperRightOffset.x + iconOffsetX, tileUpperRight.y + enduranceBarUpperRightOffset.y, enduranceBarSize.x, enduranceBarSize.y, barBackgroundColors[0], barBackgroundColors[1], barBackgroundColors[2], barBackgroundColors[3]);
		
		//health bar
		shapeRenderer.rect(tileUpperRight.x + healthBarUpperRightOffset.x + iconOffsetX, tileUpperRight.y + healthBarUpperRightOffset.y, healthBarSize.x * health, healthBarSize.y, healthBarColors[0], healthBarColors[1], healthBarColors[2], healthBarColors[3]);
		
		//armor bar
		shapeRenderer.rect(tileUpperRight.x + armorBarUpperRightOffset.x + iconOffsetX, tileUpperRight.y + armorBarUpperRightOffset.y, armorBarSize.x * armor, armorBarSize.y, armorBarColors[0], armorBarColors[1], armorBarColors[2], armorBarColors[3]);
		
		//mana bar
		shapeRenderer.rect(tileUpperRight.x + manaBarUpperRightOffset.x + iconOffsetX, tileUpperRight.y + manaBarUpperRightOffset.y, manaBarSize.x * mana, manaBarSize.y, manaBarColors[0], manaBarColors[1], manaBarColors[2], manaBarColors[3]);

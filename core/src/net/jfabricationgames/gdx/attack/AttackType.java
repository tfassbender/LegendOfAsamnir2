...
public enum AttackType {
	...
	ANIMATED_PROJECTILE(PROJECTILE), //
	WAND(MAGIC), //
	MAGIC_WAVE(MAGIC), //
	FORCE_FIELD(MAGIC), //
	...
	HOMING_MAGIC_BLAST_INERTIAL_MASS(HOMING_PROJECTILE), //
	LICH_MINION_MAGIC_BLAST(HOMING_MAGIC_BLAST_INERTIAL_MASS), //
	BEAM(ATTACK), //
	CONTINUOUS_MAP_DAMAGE(ATTACK),//
	LASER_BLASTER_BEAM(ATTACK); // 

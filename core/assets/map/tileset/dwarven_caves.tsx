...
<tileset version="1.10" tiledversion="1.10.2" name="dwarven_caves" tilewidth="32" tileheight="32" spacing="6" margin="2" tilecount="476" columns="14">
 <image source="images/restricted/dwarven_caves_tileset.png" width="532" height="1292"/>
 <tile id="448">
  <animation>
